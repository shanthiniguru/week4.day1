...
public class ServiceNow {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.get("https://dev94863.service-now.com");
		...
		driver.findElement(By.xpath("//input [@id='user_password']")).sendKeys("Jesusisgreat@9");
		...
		driver.findElement(By.xpath("//input [@id = 'incident.short_description']")).sendKeys("SHAN");
